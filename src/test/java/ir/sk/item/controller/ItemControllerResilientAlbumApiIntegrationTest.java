...
// this one to test what happens when iTune API is not available
@SpringBootTest(classes = ItemSearchApplication.class,
        webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT, properties = {"spring.application.iTunes.baseUrl=https://apple-wrong.com"})
class ItemControllerResilientAlbumApiIntegrationTest {
